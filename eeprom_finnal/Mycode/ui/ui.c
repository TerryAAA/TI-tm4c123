...
static void UI_Adj(void){
	...
	switch(Mode_Select){
		...
		case Parameter1:
			...
			LCD_ShowNum(60-10,0,Parameter_Buffer[0],5,RED);
			
			LCD_ShowString(40-10,20, "P2:" , GREEN);
			LCD_ShowNum(60-10,20,Parameter_Buffer[1],5,RED);
			
			LCD_ShowString(40-10,40, "P3:"  , GREEN);
			LCD_ShowNum(60-10,40,Parameter_Buffer[2],5,RED);
			
			LCD_ShowString(40-10,60, "P4:"  , GREEN);
			LCD_ShowNum(60-10,60,Parameter_Buffer[3],5,RED);

			LCD_ShowString(40-10,80, "P5:", GREEN);
			LCD_ShowNum(60-10,80,Parameter_Buffer[4],5,RED);
			
			LCD_ShowString(40-10,100, "P6:" , GREEN);
			LCD_ShowNum(60-10,100,Parameter_Buffer[5],5,RED);
			
			LCD_ShowString(40-10,120, "P7:"  , GREEN);
			LCD_ShowNum(60-10,120,Parameter_Buffer[6],5,RED);
			
			LCD_ShowString(40-10,140, "P8:"  , GREEN);
			LCD_ShowNum(60-10,140,Parameter_Buffer[7],5,RED);

			LCD_ShowString(40-10,160, "P9:", GREEN);
			LCD_ShowNum(60-10,160,Parameter_Buffer[8],5,RED);
			
			LCD_ShowString(40-10,180, "Parameter_Save"  , MAGENTA);
			LCD_ShowString(40-10,200, "BACK"  , MAGENTA);
			
			LCD_ShowString(150-30,0, "P10:", GREEN);
			LCD_ShowNum(180-30,0,Parameter_Buffer[9],5,RED);
			
			LCD_ShowString(150-30,20, "P11:" , GREEN);
			LCD_ShowNum(180-30,20,Parameter_Buffer[10],5,RED);
			
			LCD_ShowString(150-30,40, "P12:"  , GREEN);
			LCD_ShowNum(180-30,40,Parameter_Buffer[11],5,RED);
			
			LCD_ShowString(150-30,60, "P13:"  , GREEN);
			LCD_ShowNum(180-30,60,Parameter_Buffer[12],5,RED);

			LCD_ShowString(150-30,80, "P14:", GREEN);
			LCD_ShowNum(180-30,80,Parameter_Buffer[13],5,RED);
			
			LCD_ShowString(150-30,100, "P15:" , GREEN);
			LCD_ShowNum(180-30,100,Parameter_Buffer[14],5,RED);
			
			LCD_ShowString(150-30,120, "P16:"  , GREEN);
			LCD_ShowNum(180-30,120,Parameter_Buffer[15],5,RED);
			
			LCD_ShowString(150-30,140, "P17:"  , GREEN);
			LCD_ShowNum(180-30,140,Parameter_Buffer[16],5,RED);
			
				
			LCD_ShowString(150-30,160, "P18:", GREEN);
			LCD_ShowNum(180-30,160,Parameter_Buffer[17],5,RED);
			...
			switch(ParameterAdj){
				...
				default:
					...
					if(UIcount3==-10){
						...
						Parameter_Buffer[ParameterAdj-1]+=UIcount3;
					}
					break;
			}
			break;
